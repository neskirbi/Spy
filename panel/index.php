      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a data-toggle="modal" data-target="#Mmensajes" class="small-box-footer">Ver  <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a data-toggle="modal" data-target="#Mcontactos" class="small-box-footer">Ver  <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
...
<div class="modal fade bs-example-modal-lg" id="Mmensajes" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content" >
      <div class="modal-header">
        <input id="smensajes"  type="text" placeholder="Search..">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">LLamadas</h4>
      </div>
      <div class="modal-body">
...
<div class="modal fade bs-example-modal-lg" id="Mcontactos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content" >
      <div class="modal-header">
        <input id="scontactos"  type="text" placeholder="Search..">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
